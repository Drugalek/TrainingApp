...
import 'custom_trainings_model.dart';
export 'custom_trainings_model.dart';

class CustomTrainingsWidget extends StatefulWidget {
  const CustomTrainingsWidget({Key? key}) : super(key: key);

  @override
  _CustomTrainingsWidgetState createState() => _CustomTrainingsWidgetState();
}

class _CustomTrainingsWidgetState extends State<CustomTrainingsWidget> {
  late CustomTrainingsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CustomTrainingsModel());
  }
